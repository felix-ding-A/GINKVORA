...
export const PRESET_INGREDIENTS: PresetIngredient[] = [
  // Supplements
  { nameCn: 'Vitamin C', nameEn: 'Vitamin C (Ascorbic Acid)', formula: 'C6H8O6', mw: 176.12, category: 'supplement', type: 'Vitamin', desc: 'Powerful antioxidant, promotes collagen synthesis, recommended daily allowance (RDA) is 100mg.' },
  { nameCn: 'Vitamin E', nameEn: 'Vitamin E (Tocopherol)', formula: 'C29H50O2', mw: 430.71, category: 'supplement', type: 'Vitamin', desc: 'Lipid-soluble antioxidant, protects cell membranes, RDA is 15mg.' },
  { nameCn: 'Vitamin A', nameEn: 'Vitamin A (Retinol)', formula: 'C20H30O', mw: 286.45, category: 'supplement', type: 'Vitamin', desc: 'Maintains healthy vision, skin, and gene transcription.' },
  { nameCn: 'Vitamin D3', nameEn: 'Vitamin D3 (Cholecalciferol)', formula: 'C27H44O', mw: 384.64, category: 'supplement', type: 'Vitamin', desc: 'Promotes intestinal absorption of calcium and phosphorus, maintains bone health.' },
  { nameCn: 'Coenzyme Q10', nameEn: 'Coenzyme Q10', formula: 'C59H90O4', mw: 863.34, category: 'supplement', type: 'Coenzyme', desc: 'Coenzyme for cellular energy metabolism, strong antioxidant, cardioprotective. Suggested dose 30-50mg.' },
  { nameCn: 'Resveratrol', nameEn: 'Resveratrol', formula: 'C14H12O3', mw: 228.24, category: 'supplement', type: 'Polyphenol', desc: 'Polyphenol antioxidant, anti-aging, cardiovascular protection.' },
  { nameCn: 'Lutein', nameEn: 'Lutein', formula: 'C40H56O2', mw: 568.87, category: 'supplement', type: 'Carotenoid', desc: 'Protects retinal macula, filters harmful blue light, daily dose about 10mg.' },
  { nameCn: 'Zinc Gluconate', nameEn: 'Zinc Gluconate', formula: 'C12H22O14Zn', mw: 455.68, category: 'supplement', type: 'Mineral', desc: 'Highly bioavailable zinc supplement, enhances immunity and wound healing.' },
  
  // Cosmetics
  { nameCn: 'Niacinamide', nameEn: 'Niacinamide', formula: 'C6H6N2O', mw: 122.13, category: 'cosmetic', type: 'Active / Sebum Control', desc: 'Inhibits melanin transfer, sebum control, barrier repair. Recommended ratio 2-5%.' },
  { nameCn: 'Salicylic Acid', nameEn: 'Salicylic Acid', formula: 'C7H6O3', mw: 138.12, category: 'cosmetic', type: 'Acne Control / Exfoliator', desc: 'Lipophilic BHA, clears sebum and dead skin cells, regulatory limit 2%.' },
  ...
  { nameCn: 'Dipotassium Glycyrrhizinate', nameEn: 'Dipotassium Glycyrrhizinate', formula: 'C42H60K2O16', mw: 899.13, category: 'cosmetic', type: 'Soothing / Anti-inflammatory', desc: 'Licorice extract, excellent anti-inflammatory and soothing effect, reduces redness, limit 0.5%.' },
  { nameCn: 'Sodium Hyaluronate', nameEn: 'Sodium Hyaluronate monomer', formula: 'C14H20NNaO11', mw: 401.30, category: 'cosmetic', type: 'Humectant', desc: 'Monomer of natural moisturizing factor, extremely strong water retention capability.' },
  { nameCn: 'Allantoin', nameEn: 'Allantoin', formula: 'C4H6N4O3', mw: 158.12, category: 'cosmetic', type: 'Repair / Soothing', desc: 'Promotes cell regeneration and wound healing, soothes dry flaky skin, ratio 0.1-0.5%.' },
  ...
  { nameCn: 'Panthenol', nameEn: 'Panthenol', formula: 'C9H19NO4', mw: 205.25, category: 'cosmetic', type: 'Humectant / Repair', desc: 'Deeply penetrating humectant, promotes epithelial cell proliferation and repair, ratio 0.5-5%.' }
];
