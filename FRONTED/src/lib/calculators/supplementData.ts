...
export const SUPPLEMENT_TEMPLATES: Record<string, SupplementTemplate> = {
  tablet: {
    ...
    nameCn: 'Tablet Standard Template',
    unitLabel: 'Tablet',
    targetWeight: 500, // 500mg
    excipients: [
      { nameCn: 'Microcrystalline Cellulose', nameEn: 'Microcrystalline Cellulose', type: 'filler', typicalPct: '30-60%', defaultPct: 50 },
      { nameCn: 'Povidone K30', nameEn: 'Povidone K30', type: 'binder', typicalPct: '2-5%', defaultPct: 3 },
      { nameCn: 'Croscarmellose Sodium', nameEn: 'Croscarmellose Sodium', type: 'disintegrant', typicalPct: '2-5%', defaultPct: 3 },
  ...
  capsule: {
    ...
    nameCn: 'Hard Capsule Standard Template',
    unitLabel: 'Capsule',
    ...
    excipients: [
      ...
      { nameCn: 'Microcrystalline Cellulose', nameEn: 'Microcrystalline Cellulose', type: 'filler', typicalPct: '10-30%', defaultPct: 20 },
      { nameCn: 'Magnesium Stearate', nameEn: 'Magnesium Stearate', type: 'lubricant', typicalPct: '0.5-1.5%', defaultPct: 1 }
    ]
  },
  softgel: {
  ...
  liquid: {
    ...
    nameCn: 'Oral Liquid Standard Template',
    unitLabel: 'Vial (10mL)',
  ...
  powder: {
    ...
    nameCn: 'Powder Blend Standard Template',
    unitLabel: 'Sachet (5g)',
